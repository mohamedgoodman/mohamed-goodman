...
export function ComingSoon() {
  return (
    ...
    >
      ...
      >
        <div className="absolute top-1/2 left-1/2 h-72 w-[36rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[conic-gradient(from_0deg,theme(colors.indigo.500),theme(colors.fuchsia.500),theme(colors.amber.400),theme(colors.indigo.500))] opacity-20 blur-[100px]" />
      </div>
